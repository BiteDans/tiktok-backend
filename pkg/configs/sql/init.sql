...
(
    `id`         bigint unsigned NOT NULL AUTO_INCREMENT COMMENT 'PK',
    `author_id`   bigint unsigned NOT NULL DEFAULT '' COMMENT 'Author (user) id',
    ...
    `likes`     text NOT NULL DEFAULT '' COMMENT 'Array of user ids that like the video',
    `comments`      text NOT NULL DEFAULT '' COMMENT 'Array of comments under the video',
